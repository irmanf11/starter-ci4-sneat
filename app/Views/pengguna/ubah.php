...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Data Pengguna /</span> Ubah</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= route_to('pengguna.ubah', $pengguna['id']) ?>" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" id="level" name="level" required>
                                    ...
                                    <option value="User" <?= old('level', $pengguna['level']) == 'User' ? 'selected' : '' ?>>User</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="aktif" id="status1" value="1" <?= old('aktif', $pengguna['aktif']) == '1' ? 'checked' : '' ?> />
                                    <label class="form-check-label" for="status1">Aktif</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="aktif" id="status2" value="0" <?= old('aktif', $pengguna['aktif']) == '0' ? 'checked' : '' ?> />
